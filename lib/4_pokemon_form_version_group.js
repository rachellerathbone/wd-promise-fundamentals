...
module.exports.getName = function(getJSON, url) {
  return getJSON(url)
    ...
    .then((version_group) => version_group.name)
    .catch((err) => err);
};
...
module.exports.getId = function(getJSON, url) {
  return getJSON(url)
    ...
    .then((version_group) => version_group.id)
    .catch((err) => err);
};
...
module.exports.getPokedexes = function(getJSON, url) {
  return getJSON(url)
    .then((pokemon) => getJSON(pokemon.forms[0].url))
    .then((form) => getJSON(form.version_group.url))
    .then((version_group) => version_group.pokedexes)
    .catch((err) => err);
};
...
module.exports.getPokedexesCount = function(getJSON, url) {
  return getJSON(url)
    .then((pokemon) => getJSON(pokemon.forms[0].url))
    .then((form) => getJSON(form.version_group.url))
    .then((version_group) => version_group.pokedexes.length)
    .catch((err) => err);
};
...
module.exports.getFirstPokedex = function(getJSON, url) {
  return getJSON(url)
    .then((pokemon) => getJSON(pokemon.forms[0].url))
    .then((form) => getJSON(form.version_group.url))
    .then((version_group) => version_group.pokedexes[0])
    .catch((err) => err);
};
...
module.exports.getVersions = function(getJSON, url) {
  return getJSON(url)
    .then((pokemon) => getJSON(pokemon.forms[0].url))
    .then((form) => getJSON(form.version_group.url))
    .then((version_group) => version_group.versions)
    .catch((err) => err);
};
...
module.exports.getVersionsCount = function(getJSON, url) {
  return getJSON(url)
    .then((pokemon) => getJSON(pokemon.forms[0].url))
    .then((form) => getJSON(form.version_group.url))
    .then((version_group) => version_group.versions.length)
    .catch((err) => err);
};
...
module.exports.getVersionsNames = function(getJSON, url) {
  return getJSON(url)
    ...
    .then((form) => getJSON(form.version_group.url))
    .then((version_group) => {
      return version_group.versions.map((version) => version.name);
    })
    .catch((err) => err);
};
...
module.exports.getVersionsUrls = function(getJSON, url) {
  return getJSON(url)
    ...
    .then((form) => getJSON(form.version_group.url))
    .then((version_group) => {
      return version_group.versions.map((version) => version.url);
    })
    .catch((err) => err);
};

// Export a function named getHabitatAndShapeFromSpeciesUrl that takes two
// arguments.
//    getJSON (function)
//    url (string)
//
...
module.exports.getHabitatAndShapeFromSpeciesUrl = function(getJSON, url) {
  ...
  return getJSON(url)
    ...
    .then((species) => {
      pokeObject.habitat = species.habitat.name;
      pokeObject.shape = species.shape.name;
